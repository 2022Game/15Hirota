...
// コンストラクタ
CStage3MenuObject::CStage3MenuObject(const CVector& pos, const CVector& scale, const CVector& rot,
...
// デストラクタ
CStage3MenuObject::~CStage3MenuObject()
{
...
// 衝突処理
void CStage3MenuObject::Collision(CCollider* self, CCollider* other, const CHitInfo& hit)
{
...
void CStage3MenuObject::ChangeState(EState state)
{
...
void CStage3MenuObject::UpdateIdle()
{
...
void CStage3MenuObject::UpdateReaction()
{
	switch (mStateStep)
	{
	case 0:
