#ifndef CRotateFloorGimmickOppositionOPPOSITION_H
#define CRotateFloorGimmickOppositionOPPOSITION_H
...
// マリオ風の回転ギミック(プレイヤー反応)反対
class CRotateFloorGimmickOpposition : public CObjectBase
{
public:
	/// <summary>
	/// コンストラクタ
	...
	CRotateFloorGimmickOpposition(const CVector& pos, const CVector& scale, const CVector& rot,
		ETag reactionTag, ELayer reactionLayer);

	// デストラクタ
	~CRotateFloorGimmickOpposition();
