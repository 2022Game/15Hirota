...
CMoveToNbFl1::~CMoveToNbFl1()
{
	CStageManager::RemoveTask(this);
}

// 移動ポイントを追加
void CMoveToNbFl1::AddMovePoint(const CVector& point, float time)
{
	MovePoint mp;
	mp.point = point;
	mp.time = time;
...
void CMoveToNbFl1::SetReturnRoute(bool isReturn)
{
	mIsReturn = isReturn;
}

// 状態を切り替える
void CMoveToNbFl1::ChangeMoveState(EMoveState state)
{
...
// 移動ルートを更新
void CMoveToNbFl1::UpdateMoveRoute()
{
	// 順ルートで移動中
	if (!mIsReturnMove)
	{
