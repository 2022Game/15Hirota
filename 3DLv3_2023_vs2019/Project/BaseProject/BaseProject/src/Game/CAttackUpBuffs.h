#ifndef CATTACKUPBUFFS_H
#define CATTACKUPBUFFS_H

#include "CObjectBase.h"
#include "CModel.h"

// 攻撃アップエフェクト
class CAttackUpBuffs : public CObjectBase
{
public:
	/// <summary>
	/// コンストラクタ
	...
	CAttackUpBuffs(CObjectBase* owner, const CVector& pos, const CVector& dir, float speed, float dist);
	// デストラクタ
	~CAttackUpBuffs();
