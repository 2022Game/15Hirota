#ifndef CJUMPINGKINOKOMOVETO_H
#define CJUMPINGKINOKOMOVETO_H

#include "CJumpingKinoko.h"

// 指定した移動ポイント間を移動するジャンプキノコ
class CJumpingKinokoMoveTo : public CJumpingKinoko
{
public:
	/// <summary>
	/// コンストラクタ
	...
	CJumpingKinokoMoveTo(const CVector& scale, const CVector& rot, float waitTime);
	// デストラクタ
