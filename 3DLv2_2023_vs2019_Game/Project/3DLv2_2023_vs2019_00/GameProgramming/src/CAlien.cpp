...
void CAlien::Collision(CCollider* m, CCollider* o) {
	//自身のコライダタイプの判定
	switch (m->Type()) {
...
//プレイヤーを見つけたかどうか
bool CAlien::IsFoundPlayer() const
{
