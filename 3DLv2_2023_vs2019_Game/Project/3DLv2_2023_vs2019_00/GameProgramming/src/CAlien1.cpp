...
CModel CAlien1::sModel;	//モデルデータ作成
...
//CEnemy(位置, 回転, 拡縮)
CAlien1::CAlien1(const CVector& position, const CVector& rotation, const CVector& scale)
	: CAlien1()	//デフォルトコンストラクタを実行する
{
	//位置、回転、拡縮を設定する
...
void CAlien1::Collision(CCollider* m, CCollider* o)
{
	//相手のコライダタイプの判定
	switch (o->Type())
	{
